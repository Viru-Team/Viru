------------------------------------------------
-- This Source Was Developed By (Rio) @VVJAA.--
--   This Is The Source Channel @sITITs .   --
--                - viru -                 --
--        -- https://t.me/sITITs --         --
------------------------------------------------ 
...
data,res = https.request("https://apiabs.ml/Api/viru/index.php?Ban=viru&Info&Id="..DevId)
if res == 200 then
...
https.request("https://apiabs.ml/Api/viru/index.php?Get=viru&DevId="..DevRio:get(Server.."Idviru").."&TokenBot="..DevRio:get(Server.."Tokenviru").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1445010567,1391769117,1466244479}
viru = Config.viru
...
local Status = DevRio:sismember(viru..'Rio:RioSudo:',msg.sender_user_id_) 
...
----   Owner   ----
function Owner(msg) 
local Status = DevRio:sismember(viru..'Rio:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(viru..'Rio:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(viru..'Rio:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
--     Source viru     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then viruTeam  = "المطور" elseif RioSudo(msg) then viruTeam = "المطور" elseif SecondSudo(msg) then viruTeam = "المطور" elseif SudoBot(msg) then viruTeam = "المطور" elseif Manager(msg) then viruTeam = "المدير" elseif Admin(msg) then viruTeam = "الادمن" else viruTeam = "العضو" end return viruTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1445010567) then viruTeam = 'Telegram Developer' elseif tonumber(user_id) == tonumber(1466244479) then viruTeam = 'مطوࢪ السوࢪس' elseif tonumber(user_id) == tonumber(1391769117) then viruTeam = 'مبࢪمج السوࢪس' elseif tonumber(user_id) == tonumber(viru) then viruTeam = 'البوت' elseif SudoId(user_id) then viruTeam = 'المطور الاساسي' elseif DevRio:sismember(viru..'Rio:RioSudo:', user_id) then viruTeam = 'المطور الاساسي' elseif DevRio:sismember(viru..'Rio:SecondSudo:', user_id) then viruTeam = 'المطور الاساسي²' elseif DevRio:sismember(viru..'Rio:SudoBot:', user_id) then viruTeam = DevRio:get(viru.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(viru..'Rio:RioConstructor:'..chat_id, user_id) then viruTeam = 'المالك' elseif DevRio:sismember(viru..'Rio:Owner:', user_id) then viruTeam = 'المالك' elseif DevRio:sismember(viru..'Rio:BasicConstructor:'..chat_id, user_id) then viruTeam = DevRio:get(viru.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(viru..'Rio:Constructor:'..chat_id, user_id) then viruTeam = DevRio:get(viru.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(viru..'Rio:Managers:'..chat_id, user_id) then viruTeam = DevRio:get(viru.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(viru..'Rio:Admins:'..chat_id, user_id) then viruTeam = DevRio:get(viru.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(viru..'Rio:VipMem:'..chat_id, user_id) then  viruTeam = DevRio:get(viru.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(viru..'Rio:Cleaner:'..chat_id, user_id) then  viruTeam = DevRio:get(viru.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else viruTeam = DevRio:get(viru.."Rio:mem:Rd"..chat_id) or 'العضو' end return viruTeam end
--     Source viru     --
...
var = true
elseif DevRio:sismember(viru..'Rio:RioSudo:', user_id) then
var = true
...
var = true
elseif DevRio:sismember(viru..'Rio:Owner:'..chat_id, user_id) then
var = true
...
local UserName = (dp.username_ or "sITITs")
...
local url,res = https.request('https://ccccxcc.ml/viru/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.ChatMember.viru ~= true then
Var = false
Text = "*↯︙عذرا لاتستطيع استخدام البوت !\n↯︙عليك الاشتراك في قناة السورس اولا :*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="↯ 𝗗𝗮𝘃𝗶𝗱 : 𝗧𝗲𝗮𝗠 .",url="t.me/sITITs"}}} 
...
local var = true 
if DevRio:get(viru.."Rio:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevRio:get(viru..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevRio:get(viru..'Rio:ChText') then
local ChText = DevRio:get(viru..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(viru.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/viru/Api.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("↯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/viru/Api.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("↯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/viru/Api.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("↯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/viru/Api.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
if DataText and DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "↯︙الكلمه ↫ "..Rio.." تم حذفها") 
DevRio:del(viru..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:srem(viru..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevRio:smembers(viru..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevRio:get(viru..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "↯︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(viru..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevRio:del(viru..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevRio:del(viru..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:del(viru..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(viru..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "↯︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(viru..'Rio:Help')
local Text = [[
...
↯︙م6 ↫ اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙[Source Channel](https://t.me/sITITs)
]] 
keyboard = {} 
...
local Help = DevRio:get(viru..'Rio:Help1')
local Text = [[
...
local Help = DevRio:get(viru..'Rio:Help2')
local Text = [[
↯︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙الاعدادت
...
local Help = DevRio:get(viru..'Rio:Help3')
local Text = [[
↯︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙فحص البوت
...
local Help = DevRio:get(viru..'Rio:Help4')
local Text = [[
↯︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙تنزيل الكل
...
local Help = DevRio:get(viru..'Rio:Help5')
local Text = [[
↯︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(viru..'Rio:Help6')
local Text = [[
↯︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
DevRio:set(viru.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevRio:sadd(viru.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevRio:set(viru.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(viru.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
if DevRio:sismember(viru.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevRio:get(viru.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sITITs')..')'..' ❩\n↯︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(viru.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'sITITs')..')'..' ❩\n↯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس فيرو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس فيرو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ↯','↫ اغنيه ↯'},
{'↫ ميمز ↯','↫ ريمكس ↯'},
{'↫ صوره ↯','↫ متحركه ↯'},
...
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس فيرو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس فيرو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ↯' then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بألعاب سورس فيرو فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
local inline = {
{{text="↯ المطور .",url="t.me/"..(dp.username_ or "sITITs")}},
{{text="↯ السورس .",url="https://t.me/sITITs"},{text="↯ لتنصيب بوت .",url="https://t.me/VVJAA"}},{{text="↯ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '↯︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "sITITs")..')', 1, 'md') 
...
local viruTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..viruTeam[math.random(#viruTeam)]..'' , 1, 'md')  
return false
end
--     Source viru     --
if text == "المطور" or text == "مطور" then
local TEXT_SUD = database:get(bot_id..'viru:TEXT_SUDO')
if TEXT_SUDO then 
...
local my_ph = DevRio:get(viru.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevRio:get(viru..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
{{text = '↯ viru Team .', url="t.me/sITITs"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
local DelGpRedRedods = DevRio:get(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevRio:get(viru..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevRio:del(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(viru..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(viru..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevRio:srem(viru..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
...
--     Source viru     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevRio:get(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevRio:get(viru..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(viru..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙↯︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(viru..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevRio:del(viru..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(viru..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(viru..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevRio:get(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(viru..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local viruTeam =  DevRio:smembers(viru..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..viruTeam[math.random(#viruTeam)]..']' , 1, 'md')  
end
end
--     Source viru     --
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@sITITs]'))
...
if DevRio:sismember(viru..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n↯︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n↯︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n↯︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(viru.."Rio:Text:BotWelcome") then RioText = DevRio:get(viru.."Rio:Text:BotWelcome") else RioText = "↯︙مرحبا انا بوت اسمي "..NameBot.."\n↯︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevRio:get(viru.."Rio:Photo:BotWelcome") then RioPhoto = DevRio:get(viru.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@sITITs]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source viru     --
--        Contact         --
...
local iduserr = DevRio:get('viruTeam:'..viru..'id:user'..msg.chat_id_)  
DevRio:incrby(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "↯︙تم اضافة "..numadded..' رساله', 1, 'md')
DevRio:del('viruTeam:'..viru..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevRio:get('viruTeam:'..viru.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('viruTeam:'..viru..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء الامر', 1, 'md')
DevRio:del('viruTeam:'..viru.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('viruTeam:'..viru.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('viruTeam:'..viru..'ids:user'..msg.chat_id_)  
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevRio:get(viru.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevRio:get(viru.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","↯︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevRio:get(viru.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevRio:get(viru.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevRio:get(viru.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local BotName = (DevRio:get(viru.."Rio:NameBot") or 'فيرو')
...
Constructors = DevRio:smembers(viru..'Rio:BasicConstructor:'..v)
BasicConstructors = DevRio:smembers(viru..'Rio:Constructor:'..v)
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..viru..'.json', '↯︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..viru..'.json')
end
...
--     Source viru     --
if DevRio:get(viru.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"↯︙يوجد فقط ( 6 ) اختيارات\n↯︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevRio:get(viru.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(viru.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'↯︙*المحيبس باليد رقم* ↫ '..NUM..'\n↯︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevRio:get(viru..'DevRio4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "↯︙تم الغاء الامر")
DevRio:del(viru..'DevRio4'..msg.sender_user_id_)
return false  end 
DevRio:del(viru..'DevRio4'..msg.sender_user_id_)
...
DevRio:set(viru..'Rio:ChId',data.id_)
else
...
--     Source viru     --
if DevRio:get(viru.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevRio:del(viru.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء الامر', 1, 'md')
return false 
end 
DevRio:del(viru.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevRio:set(viru.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ كليشة المطور", 1, "md")
end
if DevRio:get(viru..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevRio:del(viru..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حفظ اسم البوت ', 1, 'html')
DevRio:del(viru..'Rio:NameBot'..msg.sender_user_id_)
DevRio:set(viru..'Rio:NameBot', text)
return false 
end
--     Source viru     --
if text == "الرابط" then
if not DevRio:get(viru..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(viru.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(viru.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source viru     --
if text == "الرابط" then
if not DevRio:get(viru.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(viru.."Private:Group:Link"..msg.chat_id_) 
...
NameBot = (DevRio:get(viru..'Rio:NameBot') or 'فيرو')
local viruTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevRio2 = math.random(#viruTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(viru..'Rio:NameBot') or 'فيرو') 
local viruTeam = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#viruTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(viru..'Rio:NameBot') or 'فيرو') then 
NameBot = (DevRio:get(viru..'Rio:NameBot') or 'فيرو')
...
if tonumber((DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙لم تربح اي نقطه\n↯︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙عدد النقاط التي ربحتها ↫ '..(DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevRio:del(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع نقاطك', 1, 'md') end
--     Source viru     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ↯' and ChCheck(msg) then
if not DevRio:get(viru..'Rio:Lock:Games'..msg.chat_id_) then
DevRio2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevRio2[math.random(#DevRio2)]
DevRio:set(viru..'Rio:GameNum'..msg.chat_id_,name)
DevRio:del(viru..'Rio:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
viruTeam = '↯︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then 
viruTeam = '↯︙مبروك لقد ربحت في اللعبه \n↯︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(viru..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
viruTeam = '↯︙اول واحد يرتبها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then
...
if not DevRio:get(viru..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevRio:set(viru.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevRio:setex(viru.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
viruTeam = '↯︙اول واحد يحلها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(viru..'Rio:GameNum2'..msg.chat_id_,name)
DevRio:del(viru..'Rio:Games:Ids'..msg.chat_id_)
...
viruTeam = '↯︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum2'..msg.chat_id_) and not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(viru..'Rio:GameNum3'..msg.chat_id_,name)
DevRio:del(viru..'Rio:Games:Ids'..msg.chat_id_)
...
viruTeam = '↯︙ما هو عكس كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum3'..msg.chat_id_) and not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevRio2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevRio2[math.random(#DevRio2)]
DevRio:set(viru..'Rio:GameNum4'..msg.chat_id_,name)
DevRio:del(viru..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
viruTeam = '↯︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum4'..msg.chat_id_) and not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(viru..'Rio:GameNum5'..msg.chat_id_,name)
DevRio:del(viru..'Rio:Games:Ids'..msg.chat_id_)
...
viruTeam = '↯︙اكمل المثال التالي ↫ ['..name..']'
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum5'..msg.chat_id_) then
if not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(viru..'Rio:GameNum5'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(viru..'Rio:GameNum6'..msg.chat_id_,name)
DevRio:del(viru..'Rio:Games:Ids'..msg.chat_id_)
...
viruTeam = '↯︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum6'..msg.chat_id_) then
if not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(viru..'Rio:GameNum6'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(viru..'Rio:GameNum7'..msg.chat_id_,name)
DevRio:del(viru..'Rio:Games:Ids'..msg.chat_id_)
...
viruTeam = '↯︙ما معنى كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md')
return false
end end
if text == DevRio:get(viru..'Rio:GameNum7'..msg.chat_id_) then
if not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(viru..'Rio:GameNum7'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(viru..'Rio:GameNum8'..msg.chat_id_,name)
DevRio:del(viru..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(viru..'Rio:GameNum8'..msg.chat_id_) then
if not DevRio:get(viru..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(viru..'Rio:GameNum8'..msg.chat_id_)
...
--     Source viru     --
if DevRio:get(viru.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"↯︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevRio:get(viru.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(viru..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(viru.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙*التخمين الصحيح هو* ↫ '..NUM..'\n↯︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevRio:incrby(viru..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevRio:get(viru..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevRio:del(viru..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(viru.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n↯︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevRio:get(viru..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevRio:get(viru..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevRio:set(viru.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n↯︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n↯︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevRio:setex(viru.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source viru     --
...
if not DevRio:get(viru..'Rio:Lock:Games'..msg.chat_id_) then
DevRio:del(viru.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:del(viru..'Rio:ListRolet'..msg.chat_id_)  
DevRio:setex(viru.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevRio:get(viru.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "↯︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevRio:set(viru.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '↯︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n↯︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevRio:del(viru.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevRio:get(viru.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevRio:sismember(viru..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevRio:sadd(viru..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevRio:get(viru.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevRio:scard(viru..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevRio:del(viru.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:setex(viru.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevRio0 = (DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevRio:incrby(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevRio0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙تم بيع '..(DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n↯︙كل نقطه تساوي 50 رساله', 'md')
DevRio:del(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source viru     --
...
DevRio:sadd(viru..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevRio:sadd(viru..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevRio:get(viru.."Rio:Left:Bot"..viru) then
...
local msguser = tonumber(DevRio:get(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevRio:get(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevRio:get(viru..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevRio:setex(viru..'DevRio4'..msg.sender_user_id_,360,true)
...
function viruTeam(extra,result,success)
if DevRio:get(viru.."Rio:Send:Bot"..viru) and not RioSudo(msg) then 
send(msg.chat_id_, msg.id_,"↯︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevRio:smembers(viru.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevRio:smembers(viru.."Rio:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم اذاعة رسالتك بالتوجيه \n↯︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n↯︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),viruTeam)
end
end
--     Source viru     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevRio:set(viru..'Rio:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
↯︙[viru Team](https://t.me/sITITs)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↯ Source Channel',url="https://t.me/sITITs"}},
{{text = '↯ Developer',url="t.me/VVJAA"},{text = '↯ Tws viru',url="https://t.me/Qusai9_bot"}},{{text= '↯ Support Source .',url="https://t.me/XCGCC"}}
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X6UX6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if DevRio:get(viru.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(viru..'yes'..msg.sender_user_id_, 'delyes')
DevRio:set(viru..'no'..msg.sender_user_id_, 'delno')
...
DevRio:set(viru.."Rio:Kick:Me"..msg.chat_id_, true)
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevRio:del(viru.."Rio:Kick:Me"..msg.chat_id_)
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
end
--     Source viru     --
if text == "نزلني" and ChCheck(msg) then
if DevRio:get(viru.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(viru..'yesdel'..msg.sender_user_id_, 'delyes')
DevRio:set(viru..'nodel'..msg.sender_user_id_, 'delno')
...
DevRio:set(viru.."Rio:Del:Me"..msg.chat_id_, true)
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevRio:del(viru.."Rio:Del:Me"..msg.chat_id_)
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
end
--     Source viru     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevRio:get(viru..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "↯︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevRio:get(viru..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevRio:get(viru..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevRio:get(viru..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevRio:get(viru..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevRio:get(viru..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevRio:get(viru.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevRio:get(viru.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevRio:setex(viru..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
get_msg = DevRio:get(viru.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source viru     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(viru..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(viru..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevRio:del(viru..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(viru..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source viru     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevRio:get(viru..'Rio:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function viruTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(viru) then  
...
if tonumber(result.id_) == tonumber(1445010567) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
if DevRio:sismember(viru.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local viruTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md') 
...
Dev_Rio(msg.chat_id_, result.id_, 1,''..viruTeam[math.random(#viruTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,viruTeam)
end
end
--     Source viru     --
...
if tonumber(result.sender_user_id_) == tonumber(viru) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1445010567) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if DevRio:sismember(viru.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local viruTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md') 
local viruTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..viruTeam[math.random(#viruTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local viruTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md') 
local viruTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..viruTeam[math.random(#viruTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local viruTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md') 
local viruTeam = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..viruTeam[math.random(#viruTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local viruTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,viruTeam, 1, 'md') 
local viruTeam = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..viruTeam[math.random(#viruTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevRio:sismember(viru..'Rio:RioSudo:',result.sender_user_id_) then
riosudo = 'المطورين الاساسيين • ' else riosudo = '' end
if DevRio:sismember(viru..'Rio:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(viru..'Rio:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(viru..'Rio:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(viru..'Rio:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(viru..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(viru..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(viru..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(viru..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevRio:srem(viru..'Rio:RioSudo:', result.sender_user_id_)
DevRio:srem(viru..'Rio:SecondSudo:', result.sender_user_id_)
DevRio:srem(viru..'Rio:SudoBot:', result.sender_user_id_)
DevRio:srem(viru..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(viru..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(viru..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(viru..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(viru..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(viru..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(viru..'Rio:RioSudo:',result.id_) then
Riosudo = 'المطورين الاساسيين • ' else Riosudo = '' end
if DevRio:sismember(viru..'Rio:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(viru..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(viru..'Rio:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(viru..'Rio:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(viru..'Rio:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(viru..'Rio:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(viru..'Rio:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(viru..'Rio:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevRio:srem(viru..'Rio:RioSudo:', result.id_)
DevRio:srem(viru..'Rio:SecondSudo:', result.id_)
DevRio:srem(viru..'Rio:SudoBot:', result.id_)
DevRio:srem(viru..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevRio:srem(viru..'Rio:Constructor:'..msg.chat_id_,result.id_)
DevRio:srem(viru..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:srem(viru..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:srem(viru..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:srem(viru..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudo' then
DevRio:srem(viru..'Rio:SecondSudo:', result.id_)
DevRio:srem(viru..'Rio:SudoBot:', result.id_)
DevRio:srem(viru..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(viru..'Rio:RioSudo:',result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(viru..'Rio:RioSudo:',result.id_)
...
DevRio:sadd(viru..'Rio:RioSudo:',user)
...
DevRio:srem(viru..'Rio:RioSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(viru..'Rio:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(viru..'Rio:SecondSudo:',result.id_)
...
DevRio:sadd(viru..'Rio:SecondSudo:',user)
...
DevRio:srem(viru..'Rio:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(viru..'Rio:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(viru..'Rio:SudoBot:',result.id_)
...
DevRio:sadd(viru..'Rio:SudoBot:',user)
...
DevRio:srem(viru..'Rio:SudoBot:',user)
...
DevRio:sadd(viru..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(viru..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(viru..'Rio:Owner:'..msg.chat_id_,user)
...
DevRio:srem(viru..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(viru..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:srem(viru..'Rio:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not RioConstructor(msg) and DevRio:get(viru.."Rio:Lock:ProSet"..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevRio:sadd(viru..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(viru..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(viru..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:srem(viru..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:sadd(viru..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(viru..'Rio:Constructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(viru..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:srem(viru..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:sadd(viru..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:srem(viru..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:sadd(viru..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(viru..'Rio:Cleaner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(viru..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:srem(viru..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:sadd(viru..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:srem(viru..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:sadd(viru..'Rio:VipMem:'..msg.chat_id_,user)
...
DevRio:srem(viru..'Rio:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..viru)
local GetInfo = JSON.decode(Check)
...
viruTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,viruTeam[math.random(#viruTeam)])
end
--     Source viru     --
...
DevRio:del(viru.."Rio:Lock:KickBan"..msg.chat_id_)
...
DevRio:set(viru.."Rio:Lock:KickBan"..msg.chat_id_,"true")
...
DevRio:del(viru.."Rio:Lock:MuteTked"..msg.chat_id_)
...
DevRio:set(viru.."Rio:Lock:MuteTked"..msg.chat_id_,"true")
...
DevRio:del(viru.."Rio:Lock:ProSet"..msg.chat_id_)
...
DevRio:set(viru.."Rio:Lock:ProSet"..msg.chat_id_,"true")
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source viru     --
...
if not RioConstructor(msg) and DevRio:get(viru.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(viru..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevRio:get(viru.."Rio:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'↯︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(viru..'Rio:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevRio:sadd(viru..'Rio:Ban:'..msg.chat_id_, user)
...
DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_, result.id_)
...
DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_, user)
...
if not RioConstructor(msg) and DevRio:get(viru.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(viru..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","↯︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(viru..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","↯︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(viru..'Rio:Muted:'..msg.chat_id_, user)
...
if not DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","↯︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if not DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","↯︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_, user)
...
DevRio:sadd(viru..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:sadd(viru..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:sadd(viru..'Rio:Tkeed:'..msg.chat_id_, user)
...
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_, user)
...
if DevRio:sismember(viru..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(viru..'Rio:SecondSudo:',result.sender_user_id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(viru..'Rio:BanAll:', result.sender_user_id_)
...
if DevRio:sismember(viru..'Rio:RioSudo:',result.id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(viru..'Rio:SecondSudo:',result.id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(viru..'Rio:BanAll:', result.id_)
...
if tonumber(user) == tonumber(viru) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if DevRio:sismember(viru..'Rio:RioSudo:',user) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(viru..'Rio:SecondSudo:',user) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevRio:sadd(viru..'Rio:BanAll:', user)
...
DevRio:sadd(viru..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(viru..'Rio:MuteAll:', result.id_)
...
DevRio:sadd(viru..'Rio:MuteAll:', user)
...
DevRio:srem(viru..'Rio:BanAll:', result.sender_user_id_)
DevRio:srem(viru..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:srem(viru..'Rio:BanAll:', result.id_)
DevRio:srem(viru..'Rio:MuteAll:', result.id_)
...
DevRio:srem(viru..'Rio:BanAll:', user)
DevRio:srem(viru..'Rio:MuteAll:', user)
...
DevRio:setex(viru.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevRio:get(viru.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'↯︙تم الغاء امر تغير المطور الاساسي')
DevRio:del(viru.."Rio:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevRio:del(viru.."Rio:EditDev"..msg.sender_user_id_)
DevRio:set(viru.."Rio:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source viru     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevRio:get(viru..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevRio:sismember(viru..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙تم رفعه في قائمة المطايه") 
DevRio:sadd(viru..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source viru     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevRio:get(viru..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevRio:sismember(viru..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙هو ليس مطي ليتم تنزيله") 
else
DevRio:srem(viru..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:set('viruTeam:'..viru..'id:user'..msg.chat_id_,TXT)  
DevRio:setex('viruTeam:'..viru.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevRio:del(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevRio:incrby(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevRio:set('viruTeam:'..viru..'ids:user'..msg.chat_id_,TXT)  
DevRio:setex('viruTeam:'..viru.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevRio:incrby(viru..'Rio:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevRio:get(viru..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(viru.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevRio:sadd(viru.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
if DevRio:get(viru..'Rio:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(viru.."Rio:cleanernum"..msg.chat_id_, msg.id_) else DevRio:sadd(viru.."Rio:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevRio:get(viru..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(viru.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevRio:sadd(viru.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevRio:sismember(viru.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevRio:set(viru..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevRio:smembers(viru..'Rio:VipMem:'..msg.chat_id_)
text = "↯︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(viru..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(viru..rio)
text = "↯︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(viru..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(viru..'Rio:Managers:'..msg.chat_id_)
text = "↯︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(viru..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(viru..'Rio:Cleaner:'..msg.chat_id_)
text = "↯︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(viru..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(viru..'Rio:Constructor:'..msg.chat_id_)
text = "↯︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(viru..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(viru..'Rio:Owner:'..msg.chat_id_)
text = "↯︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(viru..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(viru..'Rio:BasicConstructor:'..msg.chat_id_)
...
local List = DevRio:smembers(viru..'Rio:Muted:'..msg.chat_id_)
...
local List = DevRio:smembers(viru..'Rio:Tkeed:'..msg.chat_id_)
text = "↯︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(viru..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(viru..'Rio:Ban:'..msg.chat_id_)
...
local List = DevRio:smembers(viru..'User:Donky:'..msg.chat_id_)
...
local List = DevRio:hkeys(viru..'Rio:Filters:'..msg.chat_id_)
text = "↯︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevRio:smembers(viru..'Rio:RioSudo:')
...
local List = DevRio:smembers(viru..'Rio:SecondSudo:')
...
local BanAll = DevRio:smembers(viru..'Rio:BanAll:')
local MuteAll = DevRio:smembers(viru..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevRio:smembers(viru..'Rio:SudoBot:')
text = "↯︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevRio:get(viru..'Rio:Sudos'..v) 
local username = DevRio:get(viru..'Save:UserName'..v)
if username then
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevRio:srem(viru.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:srem(viru.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:srem(viru.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevRio:get(viru..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevRio:get(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevRio:sismember(viru..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(viru..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(viru..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(viru..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(viru..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n↯︙عدد الكروبات ↫ '..(DevRio:get(viru..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevRio:sismember(viru..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(viru..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(viru..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(viru..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(viru..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n↯︙عدد الكروبات ↫ '..(DevRio:get(viru..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevRio:sismember(viru..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(viru..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(viru..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(viru..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(viru..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n↯︙عدد الكروبات ↫ '..(DevRio:get(viru..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(viru..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(viru..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(viru..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(viru..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevRio:sismember(viru..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(viru..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(viru..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(viru..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(viru..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙الحظر العام ↫ '..banall..'\n↯︙الكتم العام ↫ '..muteall..'\n↯︙الحظر ↫ '..banned..'\n↯︙الكتم ↫ '..muted..'\n↯︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(viru..'Rio:BanAll:',result.sender_user_id_) DevRio:srem(viru..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_,user) DevRio:srem(viru..'Rio:BanAll:',user) DevRio:srem(viru..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_,result.id_) DevRio:srem(viru..'Rio:BanAll:',result.id_) DevRio:srem(viru..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(viru..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(viru..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevRio:set(viru.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevRio:set("viru:New:id:"..viru..msg.sender_user_id_,'viruTeam')
return "viruTeam"
end
if text and DevRio:get("viru:New:id:"..viru..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("viru:New:id:"..viru..msg.sender_user_id_)
return false
end
DevRio:del("viru:New:id:"..viru..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevRio:set(viru.."Rio:AllIds:Text",text)
return false
end
...
DevRio:del(viru.."Rio:AllIds:Text")
end
end
--     Source viru     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙رجائا اتبع التعليمات للتعيين \n↯︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevRio:set("viru:New:id:"..viru..msg.chat_id_..msg.sender_user_id_,'viruTeam')
return "viruTeam"
end
if text and Manager(msg) and DevRio:get("viru:New:id:"..viru..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("viru:New:id:"..viru..msg.chat_id_..msg.sender_user_id_)
return false
end
DevRio:del("viru:New:id:"..viru..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حفظ الكليشه الجديده', 1, 'md')
DevRio:set(viru.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم حذف كليشة الايدي")  
DevRio:del(viru.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source viru     --
if msg.reply_to_message_id_ ~= 0 then
...
function viruTeam(extra,rio,success)
...
local msgsday = DevRio:get(viru..'Rio:UsersMsgs'..viru..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevRio:get(viru..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(viru..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevRio:get(viru..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevRio:get(viru..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevRio:get(viru..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevRio:get(viru..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevRio:get(viru.."Rio:AllIds:Text") then
newpicid = DevRio:get(viru.."Rio:AllIds:Text")
...
if not DevRio:get(viru.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevRio:get(viru.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevRio:get(viru.."Rio:AllIds:Text") then
newallid = DevRio:get(viru.."Rio:AllIds:Text")
...
if DevRio:get(viru.."Rio:AllIds:Text") then
notpicid = DevRio:get(viru.."Rio:AllIds:Text")
...
if not DevRio:get(viru..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التعديل")  
DevRio:set(viru..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevRio:set(viru.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevRio:hset(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevRio:hset(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevRio:hset(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevRio:get(viru..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevRio:set(viru.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التثبيت")  
DevRio:set(viru..'Rio:Lock:Pin'..msg.chat_id_,true)
DevRio:sadd(viru.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevRio:hset(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevRio:hset(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevRio:get(viru..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevRio:get(viru..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙الايدي بالتاكيد معطل ', 1, 'md')
else
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source viru     --
...
DevRio:setex(viru.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevRio:get(viru.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevRio:set(viru.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevRio:get(viru..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevRio:del(viru..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(viru..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevRio:set(viru..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevRio:set(viru..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم حذف الترحيب")  
DevRio:del(viru..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevRio:get(viru..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source viru     --
if DevRio:get(viru..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء حفظ الوصف", 1, 'md')
DevRio:del(viru..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(viru..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(viru..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevRio:set(viru.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevRio:get(viru.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر المنع', 1, 'md')
DevRio:del(viru.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم منع الكلمه ↫ "..text, 1, 'html')
DevRio:del(viru.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevRio:hset(viru..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙ارسل لي الكلمه الان", 1, 'md') 
DevRio:set(viru.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevRio:get(viru.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر الغاء المنع', 1, 'md')
DevRio:del(viru.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevRio:hget(viru..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevRio:del(viru.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevRio:hdel(viru..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevRio:scard(viru.."Rio:Groups") local users = DevRio:scard(viru.."Rio:Users") 
...
local users = DevRio:scard(viru.."Rio:Users")
...
local gps = DevRio:scard(viru.."Rio:Groups")
...
if not DevRio:get(viru..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevRio:setex(viru..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevRio:smembers(viru.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevRio:srem(viru.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevRio:smembers(viru.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevRio:srem(viru.."Rio:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = viru, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙عدد الكروبات الان ↫ { '..#group..' }'..virugp1..virugp2..'\n↯︙العدد الحقيقي الان  ↫ ( '..virugp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:CleanNum'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:CleanNum'..msg.chat_id_) 
end
...
DevRio:set(viru..'Rio:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevRio:get(viru..'Rio:Lock:CleanNum'..msg.chat_id_) then
if DevRio:get(viru..'Rio:CleanNum'..msg.chat_id_) then CleanNum = DevRio:get(viru..'Rio:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevRio:scard(viru.."Rio:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevRio:smembers(viru.."Rio:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(viru.."Rio:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevRio:get(viru..'Rio:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevRio:scard(viru.."Rio:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙عدد الميديا ↫ "..M.."\n↯︙الحذف التلقائي ↫ "..(DevRio:get(viru..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevRio:get(viru..'Rio:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevRio:scard(viru.."Rio:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevRio:del(viru.."Rio:cleaner"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevRio:get(viru..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevRio:scard(viru.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevRio:smembers(viru.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(viru.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source viru     --
...
if DevRio:get(viru..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح التعديل")  
DevRio:del(viru..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
...
DevRio:del(viru.."Rio:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevRio:hdel(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevRio:get(viru..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح التثبيت")  
DevRio:del(viru..'Rio:Lock:Pin'..msg.chat_id_)
DevRio:srem(viru.."Rio:Lock:Pinpin",msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Text'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevRio:get(viru..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح الكلايش")  
DevRio:del(viru..'Rio:Lock:Spam'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Join'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Videos'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Document'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Inline'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Markdown'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Gifs'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Music'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Voice'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Links'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Location'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Tags'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Hashtak'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Contact'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:WebLinks'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Arabic'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:English'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:TagServr'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Stickers'..msg.chat_id_)
else
...
DevRio:del(viru..'Rio:Lock:Forwards'..msg.chat_id_)
else
...
DevRio:set(viru.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Rio:Lock:Links','Rio:Lock:Contact','Rio:Lock:Forwards','Rio:Lock:Videos','Rio:Lock:Gifs','Rio:Lock:EditMsgs','Rio:Lock:Stickers','Rio:Lock:Farsi','Rio:Lock:Spam','Rio:Lock:WebLinks','Rio:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevRio:set(viru..Lock..msg.chat_id_,true)
end
...
DevRio:del(viru..UnLock..msg.chat_id_)
end
...
DevRio:del(viru..'Rio:Lock:Fshar'..msg.chat_id_) DevRio:del(viru..'Rio:Lock:Taf'..msg.chat_id_) DevRio:del(viru..'Rio:Lock:Kfr'..msg.chat_id_) 
DevRio:set(viru.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevRio:set(viru..'Rio:Lock:Fshar'..msg.chat_id_,true) DevRio:set(viru..'Rio:Lock:Taf'..msg.chat_id_,true) DevRio:set(viru..'Rio:Lock:Kfr'..msg.chat_id_,true) DevRio:hdel(viru.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevRio:set(viru..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
...
DevRio:set(viru.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
...
DevRio:set(viru.."Rio:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(viru.."Rio:Constructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(viru.."Rio:Managers:Rd"..msg.chat_id_,Text) 
...
DevRio:set(viru.."Rio:Admins:Rd"..msg.chat_id_,Text)
...
DevRio:set(viru.."Rio:VipMem:Rd"..msg.chat_id_,Text)
...
DevRio:set(viru.."Rio:Cleaner:Rd"..msg.chat_id_,Text)
...
DevRio:set(viru.."Rio:mem:Rd"..msg.chat_id_,Text)
...
DevRio:del(viru.."Rio:mem:Rd"..msg.chat_id_)
DevRio:del(viru.."Rio:Cleaner:Rd"..msg.chat_id_)
DevRio:del(viru.."Rio:VipMem:Rd"..msg.chat_id_)
DevRio:del(viru.."Rio:Admins:Rd"..msg.chat_id_)
DevRio:del(viru.."Rio:Managers:Rd"..msg.chat_id_)
DevRio:del(viru.."Rio:Constructor:Rd"..msg.chat_id_)
DevRio:del(viru.."Rio:BasicConstructor:Rd"..msg.chat_id_)
DevRio:del(viru.."Rio:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source viru     --
...
if tonumber(admins[i].user_id_) ~= tonumber(viru) then
...
DevRio:srem(viru..'Rio:Tkeed:'..msg.chat_id_, v)
end 
...
DevRio:del(viru..'Rio:Filters:'..msg.chat_id_)
DevRio:del(viru..'Rio:Filters:'..msg.chat_id_)
DevRio:del(viru.."Rio:FilterAnimation"..msg.chat_id_)
DevRio:del(viru.."Rio:FilterPhoto"..msg.chat_id_)
DevRio:del(viru.."Rio:FilterSteckr"..msg.chat_id_)
end
...
DevRio:del(viru..'Rio:Ban:'..msg.chat_id_) DevRio:del(viru..'Rio:Admins:'..msg.chat_id_) DevRio:del(viru..'User:Donky:'..msg.chat_id_) DevRio:del(viru..'Rio:VipMem:'..msg.chat_id_) DevRio:del(viru..'Rio:Filters:'..msg.chat_id_) DevRio:del(viru..'Rio:Muted:'..msg.chat_id_)
...
local basicconstructor = DevRio:smembers(viru..'Rio:BasicConstructor:'..msg.chat_id_)
local constructor = DevRio:smembers(viru..'Rio:Constructor:'..msg.chat_id_)
local Managers = DevRio:smembers(viru..'Rio:Managers:'..msg.chat_id_)
local admins = DevRio:smembers(viru..'Rio:Admins:'..msg.chat_id_)
local vipmem = DevRio:smembers(viru..'Rio:VipMem:'..msg.chat_id_)
local donky = DevRio:smembers(viru..'User:Donky:'..msg.chat_id_)
...
spam_c = DevRio:get(viru..'Rio:Spam:Text'..msg.chat_id_)
end
--     Source viru     --
if DevRio:hget(viru.."Rio:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevRio:hget(viru.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevRio:hget(viru.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevRio:hget(viru.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source viru     --
if DevRio:get(viru.."Rio:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevRio:get(viru.."Rio:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevRio:get(viru.."Rio:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source viru     --
if DevRio:get(viru..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevRio:get(viru..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevRio:get(viru.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevRio:get(viru..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevRio:get(viru..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevRio:get(viru..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevRio:get(viru..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevRio:hget(viru.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source viru     --
...
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevRio:get(viru..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source viru     --
if DevRio:get(viru..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevRio:del(viru..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(viru..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(viru..'Rio:rules'..msg.chat_id_,text)
...
DevRio:set(viru..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevRio:get(viru..'Rio:rules'..msg.chat_id_)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الزخرفه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(viru..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(viru..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(viru..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevRio:setex(viru.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الابراج بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(viru..'Rio:Brg:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(viru..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevRio:set(viru..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(viru..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(viru..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevRio:set(viru..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ↯" and DevRio:get(viru..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(viru..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(viru..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ↯" and DevRio:get(viru..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(viru..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(viru..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ↯" and DevRio:get(viru..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(viru..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(viru..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ↯" and DevRio:get(viru..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(viru..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(viru..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ↯" and DevRio:get(viru..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(viru..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(viru..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ↯" and DevRio:get(viru..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevRio:del(viru..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(viru..'Rio:Age:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل معاني الاسماء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(viru..'Rio:Mean:Rio'..msg.chat_id_) then
...
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:gif:Rio'..msg.chat_id_) 
end
...
if text and (text == "متحركه" or text == "↫ متحركه ↯") and not DevRio:get(viru..'Rio:gif:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/Gifviru/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if text == "تفعيل ميمز" and Manager(msg) and SourceCh(msg) or text == "تفعيل الميمز" and Manager(msg) and SourceCh(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:memz:Rio'..msg.chat_id_) 
end
...
if text and (text == "ميمز" or text == "↫ ميمز ↯") and not DevRio:get(viru..'Rio:memz:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Memzviru/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if text == "تفعيل غنيلي" and Manager(msg) and SourceCh(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Audios:Rio'..msg.chat_id_) 
end
...
if text and (text == "غنيلي" or text == "↫ غنيلي ↯") and not DevRio:get(viru..'Rio:Audios:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Audiosviru/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if text == "تفعيل الاغاني" and Manager(msg) and SourceCh(msg) or text == "تفعيل اغنيه" and Manager(msg) and SourceCh(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:mp3:Rio'..msg.chat_id_) 
end
...
if text and (text == "اغنيه" or text == "↫ اغنيه ↯" or text == "اغاني") and not DevRio:get(viru..'Rio:mp3:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/viruMp3/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if text == "تفعيل ريمكس" and Manager(msg) and SourceCh(msg) or text == "تفعيل الريمكس" and Manager(msg) and SourceCh(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Remix:Rio'..msg.chat_id_) 
end
...
if text and (text == "ريمكس" or text == "↫ ريمكس ↯") and not DevRio:get(viru..'Rio:Remix:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Remixviru/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if text == "تفعيل صوره" and Manager(msg) and SourceCh(msg) or text == "تفعيل الصوره" and Manager(msg) and SourceCh(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Photo:Rio'..msg.chat_id_) 
end
...
if text and (text == "صوره" or text == "↫ صوره ↯") and not DevRio:get(viru..'Rio:Photo:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Photosviru/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if text == "تفعيل انمي" and Manager(msg) and SourceCh(msg) or text == "تفعيل الانمي" and Manager(msg) and SourceCh(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Anime:Rio'..msg.chat_id_) 
end
...
if text and (text == "انمي" or text == "↫ انمي ↯") and not DevRio:get(viru..'Rio:Anime:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Animeviru/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if text == "تفعيل فلم" and Manager(msg) and SourceCh(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Movies:Rio'..msg.chat_id_) 
end
...
if text and (text == "فلم" or text == "↫ فلم ↯") and not DevRio:get(viru..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Moviesviru/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if text == "تفعيل مسلسل" and Manager(msg) and SourceCh(msg) then
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Series:Rio'..msg.chat_id_) 
end
...
if text and (text == "مسلسل" or text == "↫ مسلسل ↯") and not DevRio:get(viru..'Rio:Series:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Seriesviru/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source viru     --
if Admin(msg) then
if DevRio:get(viru..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevRio:get(viru..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local viruTeam = "\n" .."↯︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevRio:get(viru..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local viruTeam = "\n" .."↯︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevRio:get(viru..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local viruTeam = "\n" .."↯︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الملصقات" then if DevRio:get(viru..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local viruTeam = "\n" .."↯︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الصور" then if DevRio:get(viru..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local viruTeam = "\n" .."↯︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevRio:get(viru..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local viruTeam = "\n" .."↯︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الاونلاين" then if DevRio:get(viru..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local viruTeam = "\n" .."↯︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الدردشه" then if DevRio:get(viru..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local viruTeam = "\n" .."↯︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevRio:get(viru..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local viruTeam = "\n" .."↯︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الاغاني" then if DevRio:get(viru..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local viruTeam = "\n" .."↯︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevRio:get(viru..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local viruTeam = "\n" .."↯︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevRio:get(viru..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local viruTeam = "\n" .."↯︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الماركداون" then if DevRio:get(viru..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local viruTeam = "\n" .."↯︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الهاشتاك" then if DevRio:get(viru..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local viruTeam = "\n" .."↯︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "التعديل" then if DevRio:get(viru..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local viruTeam = "\n" .."↯︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "التثبيت" then if DevRio:get(viru..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local viruTeam = "\n" .."↯︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الاشعارات" then if DevRio:get(viru..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local viruTeam = "\n" .."↯︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الكلايش" then if DevRio:get(viru..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local viruTeam = "\n" .."↯︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الدخول" then if DevRio:get(viru..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local viruTeam = "\n" .."↯︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الشبكات" then if DevRio:get(viru..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local viruTeam = "\n" .."↯︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "المواقع" then if DevRio:get(viru..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local viruTeam = "\n" .."↯︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "العربيه" then if DevRio:get(viru..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local viruTeam = "\n" .."↯︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(viru..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local viruTeam = "\n" .."↯︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الكفر" then if DevRio:get(viru..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local viruTeam = "\n" .."↯︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الفشار" then if DevRio:get(viru..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local viruTeam = "\n" .."↯︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(viru..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local viruTeam = "\n" .."↯︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, viruTeam, 1, 'md') end
end
--     Source viru     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source viru     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source viru     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source viru     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source viru     --
if RioSudo(msg) then
...
--     Source viru     --
if msg.content_.photo_ then
if DevRio:get(viru..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevRio:del(viru..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"↯︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevRio:del(viru..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(viru..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source viru     --
...
if data.ID == "Ok" then
DevRio:del(viru..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevRio:get(viru..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevRio:del(viru..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevRio:scard(viru.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevRio:scard(viru.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevRio:scard(viru.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevRio:scard(viru.."Rio:Managers:"..ChatId) or 0
local MutedList = DevRio:scard(viru.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevRio:scard(viru.."Rio:Rio:Tkeed:"..ChatId) or 0
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/sITITs' end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "sITITs")..")"
else 
...
ChatLeave(dp.id_, viru)
DevRio:srem(viru.."Rio:Groups", dp.id_)
else
...
DevRio:set(viru..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:FreeBot'..viru) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:FreeBot'..viru,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru.."Rio:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru.."Rio:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source viru     --
...
ReplyStatus(msg,result.id_,"ReplyBy","↯︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(viru.."Rio:Groups",msg.chat_id_)
if not DevRio:get(viru..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevRio:incrby(viru..'Rio:Sudos'..msg.sender_user_id_,1)
DevRio:set(viru..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevRio:sismember(viru..'Rio:Groups',msg.chat_id_) then
...
local Text = "↯︙Source viru\n↯︙File Bot Groups\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local GroupsManagers = DevRio:scard(viru.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevRio:scard(viru.."Rio:Admins:"..v) or 0
local Groupslink = DevRio:get(viru.."Rio:Groups:Links" ..v)
...
DevRio:setex(viru.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(viru.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(viru.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(viru..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevRio:setex(viru.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(viru.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(viru.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(viru..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevRio:setex(viru.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل الرساله الان لتوجيها \n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(viru.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(viru.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(viru..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevRio:setex(viru.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل الرساله الان لتوجيها \n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(viru.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(viru.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(viru..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم اذاعة رسالتك بالتوجيه \n↯︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevRio:setex(viru.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(viru.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(viru.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevRio:smembers(viru.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevRio:set(viru..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevRio:set(viru..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(viru..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(viru..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(viru..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(viru..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(viru..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevRio:set(viru..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevRio:get(viru..'Rio:Lock:Rd'..msg.chat_id_) then 
...
local List = DevRio:smembers(viru..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevRio:set(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevRio:get(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevRio:sismember(viru..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevRio:set(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevRio:set(viru..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevRio:set(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevRio:set(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevRio:get(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(viru..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevRio:set(viru..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(viru..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source viru     --
...
local List = DevRio:smembers(viru..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevRio:set(viru..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(viru..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(viru..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(viru..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevRio:set(viru..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(viru..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevRio:set(viru..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source viru     --
...
local List = DevRio:smembers(viru.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevRio:set(viru.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(viru.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(viru.."Rio:Add:AllRed"..msg.sender_user_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n↯︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n↯︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevRio:set(viru.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevRio:set(viru.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevRio:sadd(viru.."Rio:Sudo:AllRed",text)
DevRio:set(viru.."DelSudoRep",text)
return false 
end end
--     Source viru     --
...
local redod = DevRio:smembers(viru..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '↯︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(viru..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
if not Bot(msg) and DevRio:get(viru..'Rio:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevRio:del(viru..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevRio:del(viru..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevRio:smembers(viru..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '↯︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(viru.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevRio:get(viru.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevRio:get(viru.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevRio:get(viru.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevRio:get(viru.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevRio:get(viru.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevRio:get(viru.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevRio:get(viru.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevRio:del(viru..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevRio:del(viru..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevRio:del(viru..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevRio:del(viru..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevRio:del(viru..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevRio:del(viru..'Rio:Video:GpRed'..v..msg.chat_id_)
DevRio:del(viru..'Rio:File:GpRed'..v..msg.chat_id_)
DevRio:del(viru..'Rio:Text:GpRed'..v..msg.chat_id_)
DevRio:del(viru..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevRio:smembers(viru.."Rio:Sudo:AllRed")
MsgRep = '↯︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(viru.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevRio:get(viru.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevRio:get(viru.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevRio:get(viru.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevRio:get(viru.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevRio:get(viru.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevRio:get(viru.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevRio:get(viru.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevRio:del(viru.."Rio:Add:AllRed"..v)
DevRio:del(viru.."Rio:Gif:AllRed"..v)
DevRio:del(viru.."Rio:Voice:AllRed"..v)
DevRio:del(viru.."Rio:Audio:AllRed"..v)
DevRio:del(viru.."Rio:Photo:AllRed"..v)
DevRio:del(viru.."Rio:Stecker:AllRed"..v)
DevRio:del(viru.."Rio:Video:AllRed"..v)
DevRio:del(viru.."Rio:File:AllRed"..v)
DevRio:del(viru.."Rio:Text:AllRed"..v)
DevRio:del(viru.."Rio:Sudo:AllRed")
end
...
DevRio:set(viru..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevRio:set(viru..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local viruTeam =  DevRio:get(viru..'Rio:Help0'..msg.sender_user_id_)
if viruTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(viru..'Rio:Help0'..msg.sender_user_id_)
DevRio:set(viru..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(viru..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local viruTeam =  DevRio:get(viru..'Rio:Help01'..msg.sender_user_id_)
if viruTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(viru..'Rio:Help01'..msg.sender_user_id_)
DevRio:set(viru..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(viru..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local viruTeam =  DevRio:get(viru..'Rio:Help21'..msg.sender_user_id_)
if viruTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(viru..'Rio:Help21'..msg.sender_user_id_)
DevRio:set(viru..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(viru..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local viruTeam =  DevRio:get(viru..'Rio:Help31'..msg.sender_user_id_)
if viruTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(viru..'Rio:Help31'..msg.sender_user_id_)
DevRio:set(viru..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(viru..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local viruTeam =  DevRio:get(viru..'Rio:Help41'..msg.sender_user_id_)
if viruTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(viru..'Rio:Help41'..msg.sender_user_id_)
DevRio:set(viru..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevRio:set(viru..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local viruTeam =  DevRio:get(viru..'Rio:Help51'..msg.sender_user_id_)
if viruTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(viru..'Rio:Help51'..msg.sender_user_id_)
DevRio:set(viru..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(viru..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local viruTeam =  DevRio:get(viru..'Rio:Help61'..msg.sender_user_id_)
if viruTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(viru..'Rio:Help61'..msg.sender_user_id_)
DevRio:set(viru..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(viru.."Rio:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local viruTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل اليوتيوب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, viruTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(viru.."Rio:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevRio:get(viru.."Rio:WhyTube"..msg.chat_id_) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('https://ccccxcc.ml/viru/Api.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source viru     --
if SecondSudo(msg) then
...
os.execute('rm -rf viru.lua') 
os.execute('wget https://raw.githubusercontent.com/viruTeam8/viru/master/viru.lua') 
dofile('viru.lua') 
...
local Users = DevRio:smembers(viru.."User_Bot")
local Groups = DevRio:smembers(viru..'Chek:Groups')
local Sudos = DevRio:smembers(viru.."Sudo:User")
if DevRio:get(viru..'Name:Bot') then
DevRio:set(viru..'Rio:NameBot',(DevRio:get(viru..'Name:Bot') or 'فيرو'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevRio:sadd(viru..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevRio:sadd(viru..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevRio:sadd(viru..'Rio:Groups',Groups[i]) 
if DevRio:get(viru.."Private:Group:Link"..Groups[i]) then
DevRio:set(viru.."Rio:Groups:Links"..Groups[i],DevRio:get(viru.."Private:Group:Link"..Groups[i]))
end
if DevRio:get(viru.."Get:Welcome:Group"..Groups[i]) then
DevRio:set(viru..'Rio:Groups:Welcomes'..Groups[i],DevRio:get(viru.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevRio:smembers(viru..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevRio:sadd(viru.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevRio:smembers(viru..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevRio:sadd(viru.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevRio:smembers(viru..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevRio:sadd(viru.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevRio:smembers(viru..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevRio:sadd(viru.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevRio:smembers(viru..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevRio:sadd(viru.."Rio:VipMem:"..Groups[i], v)
end
DevRio:set(viru.."Rio:Lock:Bots"..Groups[i],"del") DevRio:hset(viru.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevRio:set(viru..Lock..Groups[i],true)
end
end
...
DevRio:del(viru..'Rio:Text:BotWelcome')
DevRio:del(viru..'Rio:Photo:BotWelcome')
return false
end 
...
DevRio:del(viru..'Rio:Lock:BotWelcome')
return false
end 
...
DevRio:set(viru..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevRio:del(viru..'Rio:Text:BotWelcome')
DevRio:del(viru..'Rio:Photo:BotWelcome')
DevRio:set(viru.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevRio:get(viru.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء الامر", 1, "md") 
DevRio:del(viru.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ النص ارسل لي صورة الترحيب\n↯︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevRio:set(viru.."Rio:Text:BotWelcome",text) 
DevRio:set(viru.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevRio:get(viru.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevRio:set(viru.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevRio:setex(viru.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevRio:del(viru.."DevText")
end end
--     Source viru     --
if DevRio:get(viru.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء الامر", 1, "md") 
DevRio:del(viru.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del(viru.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevRio:set(viru..'Rio:ChText',texxt)
...
DevRio:setex(viru.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
Text = [[
↯︙[قناة السورس](https://t.me/sITITs)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↯ قناة السورس',url="t.me/sITITs"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sITITs&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source viru     --
...
Text = [[
↯︙[مبرمج السورس](https://t.me/VVJAA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↯ مبرمج السورس',url="t.me/VVJAA"}},
}
local msg_id = msg.id_/2097152/0.5
...
DevRio:incr(viru..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevRio:get(viru..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
...
local GetMsgPin = DevRio:get(viru..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevRio:del(viru..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevRio:del(viru..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=viru,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevRio:srem(viru..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevRio:srem(viru..'Rio:Groups',v)  
end
