...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1445010567,1391769117,1688091080,1658973724}
Viru = Config.Viru
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '↯ David Team .',url="t.me/sITITs"}},
} 
local msg_id = msg.id_/2097152/0.5 
