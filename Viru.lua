------------------------------------------------
-- This Source Was Developed By (amer) @B333BB.--
...
|             \_/ |_|_|  \___/              |
|-------------------------------------------|
| This Source Was Developed By(Viru) @B333BB |
|   This Is The Source Channel @sITITs . |
|                - Viru -                   |
---------------------------------------------
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,2074461232,1391769117,1466244479,1658973724}
Viru = Config.Viru
...
{{text="↯ السورس .",url="https://t.me/sITITs"},{text="↯ لتنصيب بوت .",url="https://t.me/B333BB"}},
}
...
{{text = '↯ Developer',url="t.me/B333BB"},{text = '↯ Tws Viru',url="https://t.me/B333BBBOT"}},
}
...
if tonumber(result.id_) == tonumber(2074461232) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(2074461232) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
text and (text == "غنيلي" and not DevRio:get(Viru..'Rio:Audios:Rio'..msg.chat_id_) and SourceCh(msg) then
...
Text = [[
↯︙[مبرمج السورس](https://t.me/B333BB)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↯ مبرمج السورس',url="t.me/B333BB"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/B333BB&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Viru     --
if RioSudo(msg) then 
